    ...
    <Layout description="Der Judoverein Kodokan Olsberg bietet Judo und Jiu-Jitsu für Kinder, Jugendliche und Erwachsene im Sauerland.">
      ...
      <section className="section">
        <div className="container" style={{maxWidth:'800px',textAlign:'center'}}>
          ...
          <p style={{color:'var(--text-muted)',lineHeight:1.9,marginBottom:'1.25rem'}}>
            Doch unser Verein steht für weit mehr als Training: Gemeinsame Freizeitaktivitäten, Trainingslager und Übernachtungen schaffen echte Zusammengehörigkeit und machen unseren Verein zu etwas Besonderem. Bei uns entstehen Freundschaften, Teamgeist und unvergessliche Erlebnisse – auf und neben der Matte.
          </p>
          <p style={{color:'var(--text-muted)',lineHeight:1.9}}>
            Wer Qualität, sportlichen Erfolg und eine lebendige Gemeinschaft sucht, findet bei uns die besten Voraussetzungen, um sportlich und persönlich zu wachsen.
          </p>
        </div>
      </section>
      ...
      <section className="section section-alt">
        <div className="container">
          <div className="about-intro">
            ...
            <div>
              <img src={img('/images/Hero-Test.jpg')} alt="Kodokan Olsberg" />
            </div>
          </div>
